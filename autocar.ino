...
long line_trai()
{
  ...
  distance = long((pingTime/2)*speedSound);
  return(distance);
}
...
void loop()
{
  ...
  if(khoang_cach_trai < 7 && khoang_cach_giua > DIS && khoang_cach_phai > 20)
  {
    turnRight();
    delay(5);  //  turn lightly right    
  }
  //  Obstacle on front
  else if(khoang_cach_trai > DIS && khoang_cach_giua < DIS && khoang_cach_phai > DIS)
  {
    ...
    {
      turnLeft2();
      delay(450);  //  turn 90 degree left
    }
    if(khoang_cach_trai < khoang_cach_phai)
    {
      turnRight2();
      delay(450);  //  turn 90 degree right
    }
  }
  //  Obstacle on right side
  else if(khoang_cach_trai > 20 && khoang_cach_giua > DIS && khoang_cach_phai < 7)
  {
    turnLeft();
    delay(5);  //turn lightly left  
  }
  //  Obstacle on front & left side
  else if(khoang_cach_trai < DIS && khoang_cach_giua < DIS && khoang_cach_phai > DIS)
  {
    turnRight2();
    delay(450);  //  turnRight 90 degree
  }
  //  Obstacle on front & right side
  else if(khoang_cach_trai > DIS && khoang_cach_giua < DIS && khoang_cach_phai < DIS)
  {
    turnLeft2();
    delay(450);  //  turnLeft 90 degree
  }
  ...
  else if(khoang_cach_trai < 13 && khoang_cach_giua < 13 && khoang_cach_phai < 13)
  {
    moveStop();
    delay(50);
    moveBackward();
